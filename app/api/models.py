...
class QueryRequest(BaseModel):
    ...
    repo_url: Optional[str] = Field(None, description="Full GitHub repo URL, e.g., https://github.com/scikit-learn/scikit-learn")
    k: int = Field(3, ge=1, description="Top-k results to retrieve")
    model: str = Field(default="gemini-2.5-flash", description="Model name for generation")
